...
private:
    ...
    void convert_point_cloud_to_map_update(
        pcl::PointCloud<pcl::PointXYZI> & point_cloud,
        exploration::map_update & update);

    void get_point_cloud_from_map(
    ...
    void transform_pose_stamped_to_master_map_frame(
    ...
    void transform_pose_stamped_with_origin(
        geometry_msgs::PoseStamped & pose,
        const exploration::pose * origin,
        bool inverse);
